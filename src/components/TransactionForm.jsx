...
function TransactionForm({ editingTransaction, setEditingTransaction }) {
  ...
  // Open form and fill data when editing
  useEffect(() => {
      ...
      {!showForm && (
        <div className="flex justify-center">
          <button
            ...
            className="w-full max-w-xs rounded-xl bg-blue-600 px-5 py-3.5 font-semibold text-white shadow-sm transition hover:bg-blue-700 active:scale-[0.99]"
          >
            + Add Transaction
          </button>
        </div>
